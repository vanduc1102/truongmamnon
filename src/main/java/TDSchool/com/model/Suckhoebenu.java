...
@Entity
@Table(name = "SUCKHOEBENU")
public class Suckhoebenu {
	private int suckhoebenuid;
	...
	@Id
	@Column(name = "SUCKHOEBENUID")
    @GeneratedValue(strategy=GenerationType.IDENTITY)
	public int getSuckhoebenuid() {
		return suckhoebenuid;
	}
	public void setSuckhoebenuid(int suckhoebenuid) {
		this.suckhoebenuid = suckhoebenuid;
	}
