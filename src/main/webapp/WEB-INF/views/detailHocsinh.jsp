								...
								<div class="entry-content post-detail">
									<div class="post-item">
										<div class="post-content">
											...
											<div class="row">
												<c:forEach var="Lop" items="${detailHs}" varStatus="status">
													<div class="col-md-12 col-sm-12 text-center"
														...
														<div class="single-vehicle-sorter">
															...
															<h1>${Lop.hocsinh.tenhs}</h1>

															<div class="middle-box-wrapper clearfix" style="font-weight:bold; font-size:20px; font-family:monospace;">
																<div class="middle-box">
																	<span>Ngày sinh: </span>${Lop.hocsinh.ngaysinh}<br>
																	<span>Giới tính: </span>
																		${Lop.hocsinh.gioitinh}<br>
																	<span>Sở thích: </span>${Lop.hocsinh.sothich}<br>
																	<span>Phụ huynh: </span>
																		${Lop.hocsinh.phuhuynh}<br>
