										...
										<div class="post-content">
											<div class="table-responsive">
												<table class="table table-hover table-bordered">
													...
													<thead>
														<tr>
															<th width="10%" style="background-color:aqua;">Buổi</th>
													...
													<tbody>
														<c:forEach var="Thucdontrongtuan" items="${listThucDon}"
															varStatus="status">
															<tr>
																<td style="background-color:aqua;">${Thucdontrongtuan.buoi}</td>
