										...
										<div class="post-content">
											<div class="table-responsive">
												<table class="table table-hover table-bordered">
													...
													<thead>
														<tr>
															<th width="20%" >Tháng tuổi</th>
															<th width="20%">Chiều cao bé trai</th>
															<th width="20%">Cân nặng bé trai</th>
															<th width="20%">Chiều cao bé gái</th>
															<th width="20%">Cân nặng bé gái</th>
															
															
														</tr>
													</thead>
													<tbody>
														<c:forEach var="Chuansuckhoe" items="${listCHUANSK}"
															varStatus="status">
															<tr>
