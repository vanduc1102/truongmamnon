...
<div class="content-bg">
	<div class="container">
		<c:url var="updateAction" value="/admin/Thucdontrongtuan/Update"></c:url>
		<form:form method="POST" action="${updateAction}" commandName="FThucdontrongtuan"
			class="form-horizontal col-md-6">
			<div class="form-group">
				<form:input type="hidden" class="form-control" path="thucdontrongtuanid" />
			</div>
			<div class="form-group">
				<label>Buổi:</label>
