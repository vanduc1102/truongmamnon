...
<section id="content" class="col-lg-7 col-md-8 col-sm-12" role="main" style="width:1250px;">	
	<article id="post-1478" class="post-1478 page type-page status-publish hentry">
		<header class="cloud">
		<h1>Sức Khỏe Bé Nam</h1>
						<div class="separator"></div>
		</header>
	</article>
	
<div class="content-bg  col-xs-12 col-sm-6">
		<c:url var="updateAction" value="/admin/Suckhoebenam/Update"></c:url>
		<form:form action="${updateAction}" commandName="FSuckhoebenam" style="width:100%"
			class="form-horizontal col-md-6">
			<form:input type="hidden" class="form-control" path="suckhoebenamid" />
			...
			<div class="form-group">
				...
				<form:select id="chuanCC" path="Chuansuckhoe.chuansuckhoeid"
					...
					<c:forEach var="Chuansuckhoe" items="${ListChuan}">
						<form:option value="${Chuansuckhoe.chuansuckhoeid }">
							<c:out value="${Chuansuckhoe.chuanchieucaonam}" />
						</form:option>
					</c:forEach>
				</form:select>
			</div>
			...
			<div class="form-group">
				...
				<form:select id="chuanCN" path="Chuansuckhoe.chuansuckhoeid"
					...
					<c:forEach var="Chuansuckhoe" items="${ListChuan}">
						<form:option value="${Chuansuckhoe.chuansuckhoeid }">
							<c:out value="${Chuansuckhoe.chuancannangnam}" />
						</form:option>
					</c:forEach>
				</form:select>
			</div>
				...
				<form:input class="form-control" type="hidden" path="sosanhcc" id="tinhChieucao"/>

				<form:input class="form-control" type="hidden" path="tinhtrangcc" id="hienthiCC"/>


				<form:input class="form-control" type="hidden" path="sosanhcn" id="tinhCannang"/>


				<form:input class="form-control" type="hidden" path="tinhtrangcn" id="hienthiCN"/>
	...
	<div class="container">
		<div align="center" style="margin-right:100px; width:350px;">
			...
			<table class="table table-hover">
				...
				<c:forEach var="Chuansuckhoe" items="${ListChuan}" varStatus="status">
					<tr>
