...
<div class="content-bg  col-xs-12 col-sm-6">
		<c:url var="addAction" value="/admin/Suckhoebenam/Add"></c:url>
		<form:form action="${addAction}" commandName="NSuckhoebenam" style="width:100%"
			...
			<div class="form-group">
				<label>Chọn Chuẩn Chiều Cao-Hienthi</label>
			...
			<div class="form-group">
				<label>Chọn Chuẩn Cân Nặng-hienthi</label>
			...
			<div class="form-group">
				...
				<div class="form-group">
				<input  id="txt11" type="text" name="cc" class="form-control" />
			</div>
			<div class="form-group">
				<input  id="txt22" type="text" name="cn" class="form-control" />
			</div>
			<div class="form-group">
	...
	<div class="container">
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				function tinhCN(){
					var cannangcosan = parseFloat($('#txt22').val());
					var nhapcannang = parseFloat($('#nhapCannang').val());
					var tinhCn;
