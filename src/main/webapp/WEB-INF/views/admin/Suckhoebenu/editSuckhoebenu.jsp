...
<div class="content-bg  col-xs-12 col-sm-6">
		<c:url var="updateAction" value="/admin/Suckhoebenu/Update"></c:url>
		<form:form action="${updateAction}" commandName="FSuckhoebenu" style="width:100%"
			class="form-horizontal col-md-6">
			<form:input type="hidden" class="form-control" path="suckhoebenuid" />
