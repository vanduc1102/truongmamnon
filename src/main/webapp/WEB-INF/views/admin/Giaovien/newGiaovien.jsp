...
<div class="content-bg">
	<div class="container">
		<c:url var="addAction" value="/admin/Giaovien/Add"></c:url>
		<form:form action="${addAction}" enctype="multipart/form-data" commandName="NGiaovien" class="form-horizontal col-md-6">
