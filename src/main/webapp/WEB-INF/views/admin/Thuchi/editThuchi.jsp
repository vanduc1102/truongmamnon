...
<section id="content" class="col-lg-7 col-md-8 col-sm-12" role="main">	
	<article id="post-1478" class="post-1478 page type-page status-publish hentry">
		<header class="cloud">
		<h1>Thay Đổi Thông Tin Quản Lý Thu Chi Học Sinh</h1>
...
<div class="content-bg">
	<div class="container">
		<c:url var="updateAction" value="/admin/Thuchi/Update"></c:url>
		<form:form method="POST" action="${updateAction}" commandName="FThuchi"
			class="form-horizontal col-md-6" enctype="multipart/form-data">
			<div class="form-group">
				<form:input type="hidden" class="form-control" path="thuchiid" />
			</div>
			<div class="form-group">
